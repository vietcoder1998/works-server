...
public class JPAQueryBuilder<T> {
    ...
    public JPAQueryBuilder() {
       indexer = new AtomicInteger();
    }

    public JPAQueryBuilder(AtomicInteger indexer) {
    ...
    public <U> String newSubQuery(JPASubQuery<U> subQuery) {
        JPAQueryBuilder<U> queryBuilder = new JPAQueryBuilder<>(this.indexer);
        subQuery.createSubQuery(queryBuilder);
        this.params.putAll(queryBuilder.params);
    ...
    public class Condition {
        ...
        public Condition paramCondition(String field, String operation, Object value) {
            ...
            params.put("arg"+bindParamIndex, value);
    ...
    public interface JPASubQuery<U> {
        void createSubQuery(JPAQueryBuilder<U> subQueryBuilder);
    }
