...
public class StudentRegistrationController extends BaseRESTController {
    ...
    public void registerNewStudent(@RequestParam("schoolID") String schoolID,
        ...
        NewStudentRegistrationDto fullRegistrationDto = new NewStudentRegistrationDto();
        BeanUtils.copyProperties(fullRegistrationDto, fullRegistrationDto);
        fullRegistrationDto.setUsername(registrationDto.getEmail());
